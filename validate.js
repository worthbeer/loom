...
// loads from the path argument. Usage: node validate.js <path-to-component>

const fs = require('fs');
const path = require('path');
const { runGate } = require('./tools/gate');

const USAGE = 'Usage: node validate.js <path-to-component>';

const HELP_TEXT = `${USAGE}

Runs the deterministic gate (tools/gate.js) against a single generated
...
Examples:
  node validate.js generated/Button.clean.tsx          # passes
  node validate.js generated/Button.drifted.tsx        # fails: hardcoded value (rule 1)
  node validate.js generated/Button.invented-ref.tsx   # fails: invented token ref (rule 2)
  node validate.js generated/Chip.missing-aria.tsx     # fails: missing required prop (rule 3)
  node validate.js generated/Button.renamed-prop.tsx   # fails: renamed prop (rule 4)
`;
...
// "Button.component.ts") — read_component_patterns.js's own filename
...
const GENERATED_GROUND_TRUTH = {
  'tokens.css': 'tools/generate_tokens_css.js',
  'token-resolver.ts': 'tools/generate_token_resolver.js',
};
...
// gate.js's runGate comment for why rule 4 in particular would produce a
